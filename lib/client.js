...
import { CLIENT_CLOSED, CLIENT_CONNECTED, SERVER_SHUTTING_DOWN, CLIENT_PROMPT, SERVER_PROMPT, SERVER_CLIENT_NAME } from '../utils/messages.js';
...
export const connectToServer = (username) => {
   ...
   ws.on('message', (data) => {
      ...
      if(new_prompt === SERVER_PROMPT && msg === SERVER_CLIENT_NAME) setWS(`<USER ${parsed_data.new_username}> `,parsed_data.new_username,ws);
